            ...
            <div className="app-content">
                ...
                <div class="app-content-actions">
                    ...
                    <div class="app-content-actions-wrapper">
                        <button class="app-content-headerButton">Add Tickets</button>
                    </div>
                </div>
                    ...
                    <div class="tickets-row">
                        ...
                        <div class="ticket-cell departure">
                            <div className="ticket-cell departure-airport"><span class="cell-label">Departure:</span>HAN</div>
                            <div className="ticket-cell departure-time">17/12/2025</div>
                        </div>
                        <div class="ticket-cell arrival">
                            <div className="ticket-cell arrival-airport"><span class="cell-label">Arrival:</span>SGN</div>
                            <div className="ticket-cell arrival-time">18/12/2025</div>
                        </div>
